---
id: viewer
url: total/net/developer-guide/viewer
title: View and render documents with GroupDocs.Viewer
linkTitle: Viewer
weight: 2
description: "Render Word, Excel, PDF and 170+ other formats to HTML, PDF or PNG from GroupDocs.Total for .NET, with runnable C# examples and downloadable input and output files."
keywords: GroupDocs.Viewer, render document, view document, DOCX to HTML, DOCX to PDF, DOCX to PNG, document viewer, .NET, C#
...
Every example below opens `contract.docx` and is ready to copy into a console app once you have [installed the package]({{< ref "/total/net/getting-started/installation.md" >}}).
...
```
[Download full output](/total/net/_output_files/developer-guide/viewer/ViewerRenderToHtml/viewer-render-to-html.zip)
{{< /tab >}}
{{< /tabs >}}
...
```
[Download full output](/total/net/_output_files/developer-guide/viewer/ViewerRenderToPdf/viewer-render-to-pdf.pdf)
{{< /tab >}}
{{< /tabs >}}
...
```
[Download full output](/total/net/_output_files/developer-guide/viewer/ViewerRenderToPng/viewer-render-to-png.zip)
{{< /tab >}}
{{< /tabs >}}
...
Page 3: 612x792
```
[Download full output](/total/net/_output_files/developer-guide/viewer/ViewerDocumentInfo/viewer-document-info.txt)
{{< /tab >}}
{{< /tabs >}}
...
* [GroupDocs.Viewer for .NET documentation](https://docs.groupdocs.com/viewer/net/) — the full product guide
